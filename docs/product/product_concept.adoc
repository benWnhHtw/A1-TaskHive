...
| WG-Bewohner:innen (Studenten)
| Hauptnutzer:innen der Anwendung. Sie möchten Aufgaben im Haushalt fair verteilen, Überblick behalten und Konflikte vermeiden.

| WG-Bewohner:innen (Berufstätige)
| Berufstätige Personen, die in einer WG leben. Sie haben oft feste Arbeitszeiten und wenig Zeit für Organisation, daher benötigen sie eine effiziente und verlässliche Aufgabenkoordination.

| WG-Neugründer:innen
| Personen, die eine neue WG organisieren. Sie benötigen eine einfache Struktur zur Aufgabenverteilung von Anfang an.
|===
...
| Product Owner
| Verantwortlich für Produktvision und Priorisierung.
| Klar definierte Anforderungen und Fortschritt.]
| Hoch

| Entwicklerteam
| Setzt das Produkt technisch um.
| Klare Anforderungen und stabile Rahmenbedingungen.
| Hoch

| Designer:innen
| Verantwortlich für UX und Usability.
| Intuitive und motivierende Benutzeroberfläche.
| Mittel

| WG-Bewohner:innen
| Hauptnutzer:innen der Anwendung.
| Einfache Bedienung, faire Aufgabenverteilung, Transparenz.
| Hoch
|===
